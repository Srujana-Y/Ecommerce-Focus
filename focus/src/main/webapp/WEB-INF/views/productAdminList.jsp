...
<a class="btn btn-info" role="button"  href="<c:url value="/admin/deleteProduct/${p.id }"></c:url>">
<i class="fa fa-trash-o" aria-hidden="true" ></i>Delete</a>
<a class="btn btn-info" role="button"  href="${contextRoot }/admin/updateProduct?id=<c:out value="${p.id }"></c:out>">
